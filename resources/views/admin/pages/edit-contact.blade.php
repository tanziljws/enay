            ...
            <form action="{{ route('admin.pages.contact.update') }}" method="POST">
                ...
                <div class="form-group">
                    ...
                    <small class="form-text text-muted">
                        You can use the following placeholders in your content:
                        <ul>
                            <li><code>{contact_form}</code> - Displays the contact form</li>
                            <li><code>{map}</code> - Displays a Google Map (if configured)</li>
                        </ul>
                    </small>
                    @error('content')
                        <span class="invalid-feedback" role="alert">
