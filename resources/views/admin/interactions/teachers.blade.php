...
@section('title', 'Interaksi Guru')

@section('content')
<div class="container-fluid">
    <div class="d-flex justify-content-between align-items-center mb-4">
        <h1 class="h3 mb-0 text-gray-800">
            <i class="fas fa-chalkboard-teacher"></i> Interaksi Guru
        </h1>
                    ...
                    <tbody>
                        @forelse($reactions as $reaction)
                            <tr>
                                ...
                                <td>{{ $reaction->teacher->name ?? 'N/A' }}</td>
                                <td>
                    ...
                    <tbody>
                        @forelse($comments as $comment)
                            <tr>
                                ...
                                <td>
                                    <form action="{{ route('admin.interactions.teacher.comment.delete', $comment->id) }}" method="POST" class="d-inline">
                                        @csrf
                                        @method('DELETE')
